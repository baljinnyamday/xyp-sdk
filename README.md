...
| Java | [`packages/java`](packages/java) — Maven `io.github.baljinnyamday:xyp-sdk:0.1.0-alpha.1` | alpha |
...
- **Never edit generated files** (Python: `operations/`, `services/`, `models/`,
  ...
  `src/<Group>/` directory; Java: `src/main/java/module-info.java`, `Registry.java`,
  `XypGroups.java` and every `io/github/baljinnyamday/xyp/<group>/` package); change
  the generator or the spec.
