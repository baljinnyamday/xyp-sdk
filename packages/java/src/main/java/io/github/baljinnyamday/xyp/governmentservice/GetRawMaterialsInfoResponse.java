...
/**
 * The response of {@code GS10039_getRawMaterialsInfo}: Түүхий эдийн мэдээлэл авах сервис.
 *
 ...
 */
public record GetRawMaterialsInfoResponse(List<Data> data, Extras extras) {
   ...
   */
  public static GetRawMaterialsInfoResponse decode(ResponseReader reader) {
    return new GetRawMaterialsInfoResponse(
