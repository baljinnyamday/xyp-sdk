...
/**
 * The response of {@code WS100203_isPropertyCheck}: Эд хөрөнгөтэй эсэх сервис.
 *
 ...
 *
 * @param propertyCount the {@code propertyCount} field
 ...
 */
public record IsPropertyCheckResponse(Long propertyCount, String status, Extras extras) {
   ...
   */
  public static IsPropertyCheckResponse decode(ResponseReader reader) {
    return new IsPropertyCheckResponse(
        reader.get("propertyCount", Decoders.INT),
