...
/**
 * The response of {@code WS100593_GetBankAccount}: Нэхэмжлэхийн дугаараар банкны дансны мэдээлэл
 * авах.
 *
...
public record GetBankAccountResponse(List<ListItem> list, Extras extras) {
  ...
  /**
   * An element of the {@code list} list in the response of {@code WS100593_GetBankAccount}.
   *
