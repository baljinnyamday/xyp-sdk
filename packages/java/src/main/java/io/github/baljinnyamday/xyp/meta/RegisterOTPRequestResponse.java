...
/**
 * The response of {@code WS100008_registerOTPRequest}: OTP үүсгэх хүсэлт бүртгэх сервис.
 *
 ...
 *
 * @param status tuluv
 * @param resultMsg хариу мэдэгдэл
 ...
 */
public record RegisterOTPRequestResponse(String status, String resultMsg, Extras extras) {
   ...
   */
  public static RegisterOTPRequestResponse decode(ResponseReader reader) {
    return new RegisterOTPRequestResponse(
