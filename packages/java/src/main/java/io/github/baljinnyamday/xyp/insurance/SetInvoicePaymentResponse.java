...
/**
 * The response of {@code WS100595_SetInvoicePayment}: Нэхэмжлэлийн төлбөрийг тохируулах.
 *
 ...
 */
public record SetInvoicePaymentResponse(String message, Extras extras) {
   ...
   */
  public static SetInvoicePaymentResponse decode(ResponseReader reader) {
    return new SetInvoicePaymentResponse(reader.get("message", Decoders.STRING), reader.extras());
  }
}
