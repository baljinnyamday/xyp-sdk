...
/**
 * The response of {@code WS100247_electricRequirementRequestRemove}: Цахилгааны техникийн нөхцөлийн
 * хүсэлт устгах.
 *
 ...
 */
public record ElectricRequirementRequestRemoveResponse(String result, Extras extras) {
   ...
   */
  public static ElectricRequirementRequestRemoveResponse decode(ResponseReader reader) {
    return new ElectricRequirementRequestRemoveResponse(
