...
/**
 * The response of {@code WS100106_authorizeCitizen}: Иргэнийг хурууны хээгээр баталгаажуулах
 * сервис.
 *
 ...
 */
public record AuthorizeCitizenResponse(Boolean result, Extras extras) {
   ...
   */
  public static AuthorizeCitizenResponse decode(ResponseReader reader) {
    return new AuthorizeCitizenResponse(reader.get("result", Decoders.BOOL), reader.extras());
  }
}
