...
/**
 * The response of {@code WS100222_getCadastralMap}: Кадастрын зураг авах.
 *
 ...
 *
 * @param data Кадастрын зурагны мэдээлэл
 ...
 */
public record GetCadastralMapResponse(String data, Extras extras) {
   ...
   */
  public static GetCadastralMapResponse decode(ResponseReader reader) {
    return new GetCadastralMapResponse(reader.get("data", Decoders.STRING), reader.extras());
  }
}
