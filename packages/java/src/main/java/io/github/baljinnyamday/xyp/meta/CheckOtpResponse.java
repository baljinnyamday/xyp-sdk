...
/**
 * The response of {@code WS100009_checkOtp}: нэг удаагийн нууц үг шалгах сервис.
 *
 ...
 */
public record CheckOtpResponse(Boolean isMatch, Extras extras) {
   ...
   */
  public static CheckOtpResponse decode(ResponseReader reader) {
    return new CheckOtpResponse(reader.get("isMatch", Decoders.BOOL), reader.extras());
  }
}
