...
/**
 * Response of WS100110_passportInfo: Гадаад пасспортын мэдээлэл.
 *
 * Provider: Улсын бүртгэлийн ерөнхий газар
 */
final readonly class PassportInfoResponse
{
    /**
     * @param list<PassportInfoListData> $listData
    ...
    public function __construct(
        #[ListOf(PassportInfoListData::class)]
