...
/**
 * Response of WS100116_addressTypeInfo: Хаягийн төрөл хайх.
 *
 * Provider: Улсын бүртгэлийн ерөнхий газар
 */
final readonly class AddressTypeInfoResponse
{
    /**
     * @param list<AddressTypeInfoListData> $listData
    ...
    public function __construct(
        #[ListOf(AddressTypeInfoListData::class)]
